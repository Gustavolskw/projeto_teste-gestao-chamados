...
const recentOrders = ref([
  { id: 1, client: 'João Silva', service: 'Manutenção PC', status: 'Pendente', priority: 'Alta', technician: 'Carlos' },
  { id: 2, client: 'Maria Santos', service: 'Instalação Software', status: 'Em Andamento', priority: 'Média', technician: 'Ana' },
  { id: 3, client: 'Pedro Costa', service: 'Reparo Notebook', status: 'Concluído', priority: 'Baixa', technician: 'Roberto' },
  { id: 4, client: 'Ana Oliveira', service: 'Backup Dados', status: 'Pendente', priority: 'Alta', technician: 'Paulo' },
  { id: 5, client: 'Lucas Mendes', service: 'Formatação', status: 'Em Andamento', priority: 'Média', technician: 'Carlos' }
])
    ...
    <div class="container-fluid py-4">
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text"><i class="fas fa-clock"></i> Aguardando atendimento</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text"><i class="fas fa-check-circle"></i> Finalizados hoje</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card mb-4">
        <div class="card-body">
          ...
          <div class="row mb-4">
            <div class="col-md-3">
              <select v-model="selectedStatus" class="form-select" @change="filterOrders">
            ...
            <div class="col-md-3">
              <select v-model="selectedPriority" class="form-select" @change="filterOrders">
            ...
            <div class="col-md-3">
              <select v-model="selectedTechnician" class="form-select" @change="filterOrders">
